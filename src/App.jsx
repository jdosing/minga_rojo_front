...
function App() {
  ...
  return (
    ...
    {/* <body className='xsm:w-[100vw] md:w-[10vw] '>
      <header className='xsm:w-[100vw] md:w-[10vw] '>
      <nav className='flex justify-center xsm:h-screen md:h-screen '>
          <div className='xsm:w-full xsm:h-full md:w-full md:h-[90vh] md:border-solid border-2 bg-no-repeat bg-cover bg-[url(/src/assets/images/Imagesbannerhome.png)]'> 
            <div className='flex justify-between mt-4'>
              <img className='pl-12' src="src/assets/images/Menu.png" alt="" />
              <div className='flex'>
              <img className='xsm:hidden md:pr-9' src="src/assets/images/Minga.png" alt="" />
            ...
            <div className='xsm:flex xsm:text-center xsm:flex-col xsm:text-white pl-1 pt-24  md:text-white md:pl-16 md:pt-24 xsm:my-32' >
              <h1 className='xsm:text-white text-5xl font-bold'>For the love of manga</h1>
              <h3 className='xsm:text-white font-extralight'>Explore our varieties</h3>
              <div className='flex justify-center'>
                <img className='xsm:w-[40vw] xsm: md:hidden' src="/src/assets/images/botonmovil.png" alt="" />
              </div>
              <h5 className='xsm:hidden md:font-thin'>#MingaLove❤</h5>
            </div>
          </div>      
      </nav>
    </header>
      <main className='xsm:hidden md:h-96 flex justify-center items-center border-solid border-2 max-w-screen-2xl '>        
